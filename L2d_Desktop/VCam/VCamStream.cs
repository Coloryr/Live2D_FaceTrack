...
{
    [ComVisible(false)]
    public class VCamStream : SourceStream
                        , IAMStreamControl
                        , IKsPropertySet
                        , IAMPushSource
                        , IAMLatency
                        ...
                        , IAMBufferNegotiation
    {
        ...
        public VCamStream(string _name, BaseSourceFilter _filter)
            : base(_name, _filter)
        {
        ...
        public override int SetMediaType(AMMediaType mt)
        {
            ...
            return (m_Filter as VCamFilter).SetMediaType(mt);
        }

        public override int CheckMediaType(AMMediaType pmt)
        {
            return (m_Filter as VCamFilter).CheckMediaType(pmt);
        }

        public override int GetMediaType(int iPosition, ref AMMediaType pMediaType)
        {
            return (m_Filter as VCamFilter).GetMediaType(iPosition, ref pMediaType);
        }
        ...
        public override int DecideBufferSize(ref IMemAllocatorImpl pAlloc, ref AllocatorProperties pProperties)
        {
            ...
            return (m_Filter as VCamFilter).DecideBufferSize(ref pAlloc, ref pProperties);
        }
        ...
        public override int FillBuffer(ref IMediaSampleImpl _sample)
        {
            ...
            do
            {
                ...
                hr = (HRESULT)(m_Filter as VCamFilter).FillBuffer(ref _sample);
        ...
        public int SuggestAllocatorProperties(AllocatorProperties pprop)
        {
            ...
            HRESULT hr = (HRESULT)(m_Filter as VCamFilter).SuggestAllocatorProperties(pprop);
            if (FAILED(hr))
            {
                m_pProperties = null;
                return hr;
            ...
            if (m_pProperties == null)
            {
                ...
                (m_Filter as VCamFilter).GetAllocatorProperties(m_pProperties);
            }
        ...
        public int GetAllocatorProperties(AllocatorProperties pprop)
        {
            ...
            return (m_Filter as VCamFilter).GetAllocatorProperties(pprop);
        }
        ...
        public int SetFormat(AMMediaType pmt)
        {
            ...
            if (IsConnected)
            {
                ...
                if (SUCCEEDED(hr))
                {
                    ...
                    if (SUCCEEDED(hr))
                    {
                        hr = (HRESULT)(m_Filter as VCamFilter).SetMediaType(_newType);
                    }
                    else
                    {
                        m_mt.Set(_oldType);
        ...
        public int GetNumberOfCapabilities(IntPtr piCount, IntPtr piSize)
        {
            int iCount;
            int iSize;
            HRESULT hr = (HRESULT)(m_Filter as VCamFilter).GetNumberOfCapabilities(out iCount, out iSize);
            if (hr.Failed) return hr;
        ...
        public int GetStreamCaps(int iIndex, IntPtr ppmt, IntPtr pSCC)
        {
            ...
            HRESULT hr = (HRESULT)(m_Filter as VCamFilter).GetStreamCaps(iIndex, out pmt, out _caps);
        ...
        {
            return (m_Filter as VCamFilter).GetLatency(out prtLatency);
        }
