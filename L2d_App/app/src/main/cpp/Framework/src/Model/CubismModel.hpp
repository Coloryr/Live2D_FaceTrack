...
public:
    ...
    */
    ...
    csmFloat32* GetParameterValues(){return _parameterValues;}
    const csmFloat32* GetParameterDefaultValues();
    const csmFloat32* GetParameterMaximumValues(){return _parameterMaximumValues;}
    const csmFloat32* GetParameterMinimumValues(){return _parameterMinimumValues;}
